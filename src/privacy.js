...
<div class="entry-content clear" itemprop="text">
    <div class="elementor-text-editor elementor-clearfix"><p><!-- wp:heading --><!-- /wp:heading --><!-- wp:paragraph --></p>
        ...
        <h3>Your Rights</h3>
        <p><!-- /wp:heading --><!-- wp:paragraph --></p>
        <p>If you are a European resident, you have the right to access personal information we hold about you and to ask that your personal information be corrected, updated, or deleted. If you would like to exercise this right, please contact us through&nbsp;blazesoftworks7@gmail.com.</p>
        ...
        <h3>Contact Us</h3>
        <p><!-- /wp:heading --><!-- wp:paragraph --></p>
        <p>For more information about our privacy practices or if you have questions, please contact us by e-mail at blazesoftworks7@gmail.com</p>
        <p><!-- /wp:paragraph --><!-- wp:heading --></p>
        <p><!-- /wp:heading --></p></div>
</div>
</body></html>
